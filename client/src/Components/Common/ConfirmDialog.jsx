...
const ConfirmDialog = ({
  ...
  const confirmStyles = {
    primary: 'bg-emerald-600 hover:bg-emerald-700 cursor-pointer',
    danger: 'bg-red-600 hover:bg-red-700 cursor-pointer',
  };
      ...
      >
        ...
        <div className="mt-6 flex flex-col-reverse justify-end gap-3 sm:flex-row">
          <button
            ...
            onClick={onCancel}
            disabled={loading}
            className="cursor-pointer rounded-lg border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50"
          >
            {cancelLabel}
          </button>
          <button
