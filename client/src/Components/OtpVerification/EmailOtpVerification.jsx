  ...
  return (
    <>
      <div className="min-h-screen flex justify-center items-center bg-gray-50">
        <div className="w-full bg-gray-50 px-6 py-10 flex flex-col items-center md:h-auto min-h-0 md:max-w-md md:border md:border-gray-300 md:rounded-lg -translate-y-30 md:-translate-y-10">
          <img alt="Logo" />
          ...
          <Button
            ...
            className="font-medium w-60 mt-10"
