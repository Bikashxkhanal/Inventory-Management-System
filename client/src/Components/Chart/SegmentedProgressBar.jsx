...
const SegmentedProgressBar = ({ label = "", datas = [] }) => {
  //Label is for type of data here (if stock information to highlight, then label = stock, If stafff counts to hightlight based on role thenlabel= staff)
              ...
              return (
                ...
                >
                  ...
                  <div className="text-md text-gray-700 ">
                    <p className="flex flex-col md:flex-row md:gap-2 items-center justify-center ">{item.name} 
